    ...
    <div className="">
      <div class="w-full max-w-xs overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 mx-auto">
        ...
        <section class="bg-white dark:bg-gray-900">
          ...
          <div class="flex p-4 flex-col items-center transition-colors duration-300 transform  cursor-pointer rounded-xl hover:border-transparent group hover:bg-blue-600 dark:border-gray-700 dark:hover:border-transparent justify-center space-y-4 border-black">
