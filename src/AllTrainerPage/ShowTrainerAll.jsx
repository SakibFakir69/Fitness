    ...
    <div className="p-4">
      ...
      <div class="w-full  overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 mx-auto border ">
        <section class="bg-white dark:bg-gray-900 ">
          <div class="flex p-1 flex-col items-center transition-colors duration-300 transform  cursor-pointer rounded-xl hover:border-transparent group hover:bg-blue-600 dark:border-gray-700 justify-center space-y-4 border-black ">
            <img
              src={Image}
            ...
            <NavLink
              ...
              className={"text-center flex items-center justify-center btn "}
            >
              Know More
            </NavLink>
          </div>
