    ...
    <div className="bg-gradient-to-t from-indigo-400 to-pink-500 px-6 ">
      <div className="">
        <section className="text-center  ">
          ...
          <h1 className="sm:text-4xl font-bold text-white"> Trainer Booking Details <span className=""> and Pricing Plans</span> </h1>
          ...
          <div className="mt-6 border-2 mb-2  bg-black">
            <p>
              {" "}
              <span className="text-xl text-white font-semibold">Trainer Name</span> : 

              <span className="text-xl text-red-300">{Name}</span>
            </p>
            <p>
              {" "}
              <span className="text-xl text-white font-semibold">Classes </span> : <span className="text-xl text-red-300">{Class}</span>
            </p>
            <p>
              {" "}
              <span className="text-xl text-white font-semibold">Slot  </span> : <span className="text-xl text-red-300"> {Slot}</span>
            </p>
          </div>
        </section>
          ...
          <div class="">
            <div class="">
              ...
              <p class="max-w-2xl mx-auto mt-2 text-center text-gray-300 xl:mt-6 dark:text-gray-500">
                Flexible plans tailored to your fitness goals. Select the
                package that suits your needs and start your fitness journey
                today!
              </p>
              ...
              <div class="grid grid-cols-1 gap-8 mt-6 xl:mt-10 xl:gap-12 md:grid-cols-2 lg:grid-cols-3 ">
                <div class="w-full p-8 space-y-8 text-center border border-gray-200 rounded-lg dark:border-gray-700 transition bg-violet-300 hover:bg-violet-400">
                  ...
                  <div>
                    <p className="text-xl font-semibold">
                      1. Access to gym facilities during regular operating
                      hours.
                    </p>
                    <p className="text-xl font-semibold">
                ...
                <div class="w-full p-8 space-y-8 text-center border border-gray-200 bg-transparent backdrop-blur-xl rounded-lg dark:border-gray-700 hover:bg-purple-400 transition 
                bg-violet-300">
                  <p class="font-medium text-gray-500 uppercase dark:text-gray-300">
                    Enterprise
                  </p>
