      ...
      {isLoading ? (
        ...
        <div>
          <section className="grid lg:grid-cols-3 gap-6 justify-center items-center w-full mx-auto mt-8 p-6">
            {result?.map((item, key) => (
              <div key={key} class="">
                <div class=" py-8  duration-300 border cursor-pointer rounded-xl  group bg-white  justify-center items-center p-4 border-black/20 hover:shadow-slate-700 hover:shadow-2xl h-[450px] shadow-xl">
                  <div class="flex flex-col   ">
                    ...
                    <div className="flex flex-col justify-center ">
                      ...
                      <div class=" ">
                        ...
                        <h1 class="text-xl  text-black font-semibold capitalize md:text-2xl dark:text-white mt-2 ">
                          {item.Name}
                        </h1>
                    ...
                    <p class="-mt-7  capitalize text-gray-200 group-hover:text-gray-300">
